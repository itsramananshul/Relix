...
### 7.29 Reasoning and Decision Engine — Smart Routing, Confidence, Belief Tracking, and Judge Model `[DONE — RELIX-7.29 rebuild commits 0fef9cc + c9d5327 + 3d8862d + bf005dd + b36e3c1]`
