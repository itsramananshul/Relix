...
**Relix mapping:** net-new, but it's a small, self-contained primitive. It's what lets "the CEO/planner accepts a plan → it becomes assigned issues" be crash-safe and non-duplicating — essential for autonomy.
